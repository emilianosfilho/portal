<div class="modal fade" id="inventario-modalNovo" role="dialog" aria-labelledby="" aria-hidden="true">
      ...
      <form role="form" class="STYLE-NAME" action="index.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer d-flex justify-content-between">
            ...
            <button type="submit" class="btn btn-success" name="acao" value="inventario_abrirNovo">
