...
foreach ($ARRAY_EXIBE as $paginaAtual => $pagina) {
	...
	$pdf->Cell(30, 8, "NUMORIGINAL"		  	, 'B', 0, 'L', 1);
	$pdf->Cell(55, 8, "DESCRIÇÃO"		  	, 'B', 0, 'L', 1);
	$pdf->Cell(30, 8, "MARCA"		  		, 'B', 0, 'L', 1);
	$pdf->Cell(15, 8, "Qt. PED"		  		, 'B', 0, 'C', 1);
	$pdf->Cell(15, 8, "Qt. AVAR"		  		, 'B', 0, 'C', 1);
	$pdf->Cell(15, 8, "Qt. CONF"				, 'B', 1, 'C', 1);
	...
	foreach ($pagina as $itemAtual => $item) {
		...
		$pdf->Cell(30, 8, $item['NUMORIGINAL'] 					, 'B', 0, 'L');
		$pdf->Cell(55, 8, $item['DESCRICAO'] 					, 'B', 0, 'L');
		$pdf->Cell(30, 8, $item['MARCA'] 						, 'B', 0, 'L');
		$pdf->Cell(15, 8, $item['QTPEDIDO'] 					, 'B', 0, 'C');
		$pdf->Cell(15, 8, $item['QTAVARIA'] 					, 'B', 0, 'C');
		$pdf->Cell(15, 8, $item['QTCONFERIDA'] 					, 'B', 1, 'C');
