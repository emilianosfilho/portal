    ...
    <main class="col ms-sm-auto px-3">
      ...
      <div class="row">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 border-bottom">
          <h1 class="h2">
            <i class="fa-solid fa-file-arrow-down"></i> Arquivos Download
          </h1>
        </div>
      </div>
      ...
      $diretorio = __DIR__ . '/../../download';

      // Validação do diretório
      if (!is_dir($diretorio)) {
          die('Diretório de download não encontrado.');
      }
          ...
          ?>
                      <tr>
                          ...
                          <td class="text-center">
                              <a 
                                  href="download/<?= urlencode($arquivo) ?>" 
