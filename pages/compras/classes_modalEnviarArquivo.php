<div class="modal fade" id="classes_modalEnviarArquivo" role="dialog" aria-labelledby="labelmodalAlteraSenha" aria-hidden="true">
  <div class="modal-dialog text-md" role="document">
    <div class="modal-content">
      ...
      <form role="form" class="STYLE-NAME" action="index.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="NOMEARQUIVO" value="CLASSES">
