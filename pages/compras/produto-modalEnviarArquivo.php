<div class="modal fade" id="produto-modalEnviarArquivo" role="dialog" aria-labelledby="labelmodalAlteraSenha" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form role="form" class="STYLE-NAME" action="index.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <a href="download/MODELO_CADASTRO_PRODUTO.xlsx" class="stretched-link text-primary" style="position: relative;">
