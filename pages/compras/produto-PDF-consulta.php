...
$regTotal = count($_SESSION['PRODUTOS']);
...
foreach ($ARRAY_EXIBE as $paginaAtual => $pagina) {
	...
	$pdf->Cell(30, 8, "VIDE"		  		, 'B', 0, 'L', 1);
	$pdf->Cell(90, 8, "DESCRIÇÃO"		  	, 'B', 0, 'L', 1);
	$pdf->Cell(30, 8, "MARCA"		  		, 'B', 0, 'L', 1);
	$pdf->Cell(20, 8, "LOCAÇÃO"		  		, 'B', 0, 'C', 1);
	$pdf->Cell(20, 8, "QT EST"	  			, 'B', 0, 'C', 1);
	$pdf->Cell(20, 8, "QT RESERV"  			, 'B', 1, 'C', 1);
	...
	foreach ($pagina as $itemAtual => $item) {
		...
		$pdf->Cell(30, 8, $item['VIDE'] 						, 'B', 0, 'L');
		$pdf->Cell(90, 8, $item['DESCRICAO'] 					, 'B', 0, 'L');
		$pdf->Cell(30, 8, $item['MARCA'] 						, 'B', 0, 'L');
		$pdf->Cell(20, 8, $item['LOCACAO'] 						, 'B', 0, 'C');
		$pdf->Cell(20, 8, $item['QTSALDO'] 						, 'B', 0, 'C');
		$pdf->Cell(20, 8, $item['QTRESERVADA'] 					, 'B', 1, 'C');
