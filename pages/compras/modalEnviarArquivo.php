<div class="modal fade" id="modalEnviarArquivo" role="dialog" aria-labelledby="labelmodalAlteraSenha" aria-hidden="true">
  <div class="modal-dialog text-md" role="document">
    <div class="modal-content">
      ...
      <form role="form" class="STYLE-NAME" action="index.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="NOMEARQUIVO" value="PRODUTO">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-4">
              <label class="col-form-label">Baixar modelo:</label>
            </div>
            <div class="col-8">
              <a href="download/MODELO_CADASTRO_PRODUTO.xlsx" class="btn btn-xs btn-outline-secondary"><i class="fas fa-download"></i> Modelo</a>
            </div>
          </div>
