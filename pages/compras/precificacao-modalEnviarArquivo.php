<div class="modal fade" id="precificacao-modalEnviarArquivo" role="dialog" aria-labelledby="labelmodalAlteraSenha" aria-hidden="true">
  <div class="modal-dialog text-md" role="document">
    <div class="modal-content">
      ...
      <form role="form" class="STYLE-NAME" action="index.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="op" value="115">
        ...
        <div class="modal-body">
          ...
          <a href="download/MODELO_PRECIFICACAO.xlsx" class="stretched-link text-primary" style="position: relative;">
