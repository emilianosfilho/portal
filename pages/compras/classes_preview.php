            ...
            <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <th scope="row"><?= moeda(count($_SESSION['classesSemCadastro']),0) ?></td>
                    </tr>
                  <tr>
              ...
              <div class="d-grid gap-2">
                <?php if (count($classesInvalidas) > 0): ?>
                  <a href="index.php?op=128&aba=classes&acao=classes_aplicarArquivo" title="Prosseguir" class="btn btn-success"><i class="fa-solid fa-forward"></i> Prosseguir</a>
                <?php else: ?>
