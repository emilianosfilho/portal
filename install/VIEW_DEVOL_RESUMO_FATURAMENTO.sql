...
SELECT PCFORNEC.CODFORNEC,
       ...
       COALESCE(PCMOVCOMPLE.CODSUPERVISOR,
                (SELECT CODSUPERVISOR
                  ...
                  WHERE CODUSUR = PCMOV.CODUSUR
                    AND ROWNUM = 1),
                PCNFSAID.CODSUPERVISOR) CODSUPERVMOV, -- SUPERVISOR MOVIMENTAC?O
         ...
         WHERE S.CODSUPERVISOR =
               COALESCE(PCMOVCOMPLE.CODSUPERVISOR,
                        (SELECT CODSUPERVISOR
                          ...
                          WHERE CODUSUR = PCMOV.CODUSUR
                            AND ROWNUM = 1),
                        PCNFSAID.CODSUPERVISOR)) CODCOORDENADOR, -- COORDENADOR DO SUPERVISOR DA MOVIMENTAC?O
         ...
         WHERE S.CODSUPERVISOR =
               COALESCE(PCMOVCOMPLE.CODSUPERVISOR,
                        (SELECT CODSUPERVISOR
                          ...
                          WHERE CODUSUR = PCMOV.CODUSUR
                            AND ROWNUM = 1),
                        PCNFSAID.CODSUPERVISOR)) CODGERENTELOCAL, -- GERENTE LOCAL DO COORDENADOR OU DO SUPERVISOR DA MOVIMENTAC?O
       (SELECT GR.CODGERENTE
         ...
         WHERE COALESCE(PCMOVCOMPLE.CODSUPERVISOR,
           ...
           AND GL.CODGERENTESUPERIOR = GR.CODGERENTE(+)) CODGERENTEREGIONAL, -- GERENTE REGIONAL DO GERENTE LOCAL DO COORDENADOR OU DO SUPERVISOR DA MOVIMENTAC?O
         ...
         WHERE COALESCE(PCMOVCOMPLE.CODSUPERVISOR,
           ...
           AND DECODE(S.CODCOORDENADOR,
                      ...
                      (SELECT C.CODGERENTE
                         FROM PCCOORDENADORVENDA C
                        WHERE C.CODIGO = S.CODCOORDENADOR)) = GL.CODGERENTE
           AND GL.CODGERENTESUPERIOR = GR.CODGERENTE(+)) CODGERENTENACIONAL, -- GERENTE NACIONAL DO GERENTE REGIONAL DO GERENTE LOCAL DO COORDENADOR OU DO SUPERVISOR DA MOVIMENTAC?O
