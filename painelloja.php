    ...
    <div id="painel">
        ...
        <div id="cabecalho" class="row mt-1">
      	...
      	<table class="table table-bordered">
      		<thead>
        		<tr>
        			<th class="bg-light text-dark">NUMPED</th>
        			<th class="bg-light text-dark">CLIENTE</th>
        			<th class="bg-light text-dark">VEND.</th>
        			<th class="bg-light text-dark">BALCÃO</th>
        			<th class="bg-light text-dark">STATUS</th>
        			<th class="bg-light text-dark">PREVISÃO</th>
        		</tr>
      		</thead>
      		<tbody id="pedidos">
      		</tbody>
...
(function () {
    ...
    function carregarPedidos() {
        ...
        fetchComTimeout(
            'pages/logistica/painel_json.php?acao=checkout_loja',
            ...
            if (json.pedidos && json.pedidos.length) {
                ...
                json.pedidos.forEach(function (p) {
                    ...
                    if (p.STATUSCHECKOUT === 'PENDENTE') {
                      html.push('<td class="text-white">' + p.STATUSCHECKOUT + '</td>');
                      html.push('<td class="text-white">' + p.ESPERA + '</td>');
                    } else {
                      html.push('<td class="text-info fw-bold">' + p.STATUSCHECKOUT + '</td>');
                      html.push('<td class="text-info fw-bold">' + p.ESPERA + '</td>');
                    }
                    html.push('</tr>');
                });
            } else {
